...
ws.on('open', () => {
  ...
  const payload = {
    ...
    hostId: 'host', // invalid hostId to trigger fallback logic!
    hostAvatarKey: null,
    hostName: 'Bhishan Web Test Stale Session'
  };
  
  ws.send(JSON.stringify(payload));
  console.log('Sent createRoom payload with invalid hostId:', payload);
});
